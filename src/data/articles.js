...
Early AI
There are two approaches to AI, based on how you define Intelligence — symbolic reasoning and artificial neural network. Symbolic reasoning is a top-down approach, wherein you follow the path a human took to solve a particular problem; recreate it using algorithms and feed it to the machine. Artificial neural network(ANN) is the bottom-up approach, we feed the machine with examples with which it learns to solve a problem.
