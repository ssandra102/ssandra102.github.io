...
// import robo from "./images/miniRobo.jpg";
import pacman from "../images/pac_man.jpg";
import subfields from "../images/subFieldsOfAI.webp";
        ...
        <div className="article-content" id="content">
            <div className="paragraph">
                <div>
                    ...
                    <div>
                        <br></br>
                        <h1><a href="#" id="intro"></a>Early AI</h1>
